    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("f0e290a9-9054-4ae7-af3b-08dad84feb5b"), new DateTime(1993, 3, 7, 0, 0, 0, 0, DateTimeKind.Local), "Админ", "Админ", null, "000000", "0000", "88888888888" });

            migrationBuilder.InsertData(
                table: "Accounts",
                columns: new[] { "UserId", "Email", "Login", "Password" },
                values: new object[] { new Guid("f0e290a9-9054-4ae7-af3b-08dad84feb5b"), "admin@admin.com", "admin", "$2a$11$t0sT4Nk7HfQZd3oTVrtVQ.Cxv8rV9Pcv9e7lqkdNl8SOleqweja22" });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "AccountUserId", "Name" },
                values: new object[] { new Guid("78eb95b5-d2f7-4056-aa2c-548692d248db"), new Guid("f0e290a9-9054-4ae7-af3b-08dad84feb5b"), "Администратор" });
