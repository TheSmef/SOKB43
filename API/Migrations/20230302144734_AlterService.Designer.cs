...
namespace API.Migrations
{
    ...
    [Migration("20230302144734_AlterService")]
    partial class AlterService
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Models.Entity.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Login = "admin",
                            Password = "$2a$11$mge9nfB2klcqX1LLWryuJ.vb9Vb.UNt/Y2j6poon8IUs2sMqcMGXC"
                        });
                });
            ...
            modelBuilder.Entity("Models.Entity.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("78a979fe-2ffc-44ee-9390-2162f00ee105"),
            ...
            modelBuilder.Entity("Models.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BirthDate = new DateTime(1993, 3, 2, 17, 47, 34, 444, DateTimeKind.Local).AddTicks(6807),
                            Firstname = "Админ",
                            Lastname = "Админ",
