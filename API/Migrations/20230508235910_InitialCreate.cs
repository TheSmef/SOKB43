    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("f0e290a9-9054-4ae7-af3b-08dad84feb5b"), new DateTime(1993, 5, 9, 0, 0, 0, 0, DateTimeKind.Local), "Админ", "Админ", null, "000000", "0000", "88888888888" });

            migrationBuilder.InsertData(
                table: "Accounts",
                columns: new[] { "UserId", "Email", "Login", "Password" },
                values: new object[] { new Guid("f0e290a9-9054-4ae7-af3b-08dad84feb5b"), "admin@admin.com", "admin", "$2a$11$iL7JhZiLPOC5Pj0qW8nsWek7/nBbdD/Hj3OGZtSIObkLjYdX3jqfO" });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "AccountUserId", "Name" },
                values: new object[] { new Guid("0618a478-23fe-44f1-a3ac-7712d7f2bd75"), new Guid("f0e290a9-9054-4ae7-af3b-08dad84feb5b"), "Администратор" });
