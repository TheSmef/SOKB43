...
{
    public partial class ContractorAddPage
    {
        [Inject]
        ...
        private async Task HandleAdd()
        {
            try
            {
                await ContractorService!.AddContractor(contractor);
                NotificationService!.Notify(NotificationSeverity.Success, "Успешное добавление!", "Контрагент успешно добавлен", 4000);
                Close();
            }
