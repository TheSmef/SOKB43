...
namespace WEB.Pages.DataPages.Users
{
    public partial class UsersPage
    {
        ...
        private async Task ExportUsers()
        {
            try
            {
                await UserService!.ExportUsers(query);
                NotificationService!.Notify(NotificationSeverity.Success, "Успешный экспорт сотрудников!", "Сотрудники успешно экспортированы", 4000);
            }
            catch (UnAuthException)
            {
